...
/sbin/iptables -A OUTPUT -p UDP --sport 269 --dport 269 -j ACCEPT # accept all outgoing UDP packets that are destined to and sent from port 269
...
#echo "iptable rule setup completed"
exit